...
6. In the defauly Windows Exporter textfile directory (C:\ProgramFiles\Windows Exporter\textfile_inputs) create the following empty .prom files. The monitoring scripts expects these to be present and will fail if they are not.
